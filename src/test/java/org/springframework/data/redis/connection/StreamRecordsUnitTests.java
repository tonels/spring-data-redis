...
public class StreamRecordsUnitTests {
	...
	public void serializeMapRecord() {
		...
		ByteMapRecord target = source.serialize(RedisSerializer.string());
	...
	public void deserializeByteMapRecord() {
		...
		ByteMapRecord source = StreamRecords.newRecord().in(SERIALIZED_STRING_STREAM_KEY).withId(RECORD_ID)
